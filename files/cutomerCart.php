    ...
    <header class="header">
      ...
      <nav class="menu">
        ...
        <div class="formNav">
			...
			<input class="simpleButton" type='submit' name='Psubmit' value='Produtos' />
			<!-- <input class="simpleButton" type='submit' name='Ssubmit' value='Services' /> -->
			<input class="simpleButton" type='submit' name='Shopsubmit' value='Lojas' />
			<input class="simpleButton" type='submit' name='Esubmit' value='Editar Perfil' />
			<input class="simpleButton" type='submit' name='Tsubmit' value='Pedidos' />

			<input class="simpleButton" type='submit' name='Csubmit' value='Carrinho' />
...
<h3 style="margin-left: 5%;">	  
	Total de Itens : <?php echo $rowit['totalItems'];  ?> </h3>

<h3 style="margin-left: 5%">	  
	Preço total : <?php echo $rowprice['Total'];  ?> </h3>
...
?>
	<div style=" background-image: url('<?php echo $image; ?>'); background-size: 100% 100%; background-repeat: no-repeat;"  class="product myDiv">
		...
		<form action='productOperCustomer.php' method='POST'
			...
			<input class="addstyle nonClick" style="margin-top: 236px;" type='submit' name='' value="R$ : <?php echo $row1['price']; ?>" />
			<input  type='submit' class="addstyle" name='proD' value='Detalhes' />
			<!-- <input  type='submit' class="addstyle" name='addC' value='Add to Cart' /> -->
			<input  type='submit' class="addstyle" name='rem' value='Remover' />
		</p>
	</form>
