...
<body>
  ...
  <div class="site-pusher">
	...
	<h1 style="text-align: center;">
	  Bem vindo <?php echo $row0['name'];  ?></h1>
...
?>
	<div class="product" style=" background-image: url('<?php echo $image; ?>'); background-size: 100% 100%; background-repeat: no-repeat; padding-bottom: 0; margin-top: 0;  ">
		...
		<form action='sellerDashGoToShop.php' method='POST'
			...
			<input style=" margin-top: 256px; float: right;  padding: 7px; margin-left: 10px; width: 100px; " type='submit' class="addstyle" name='ShopSubmit' value='Vá para a loja' />
			<input  type='submit' class="addstyle" name='ShopDel' value='Delete loja' style=" margin-top: 4px;   float: left;  padding: 7px; background-color: red; width: 105px; " />
		</p>
	</form>
