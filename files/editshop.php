  ...
  <div class="site-pusher">
    ...
    <div class="site-content">
		...
		<form action="editShopBack.php" method="post" style="text-align: center;">
			<h1 style="text-align: center; margin-top: 7px;">Insira os detalhes</h1>
			...
			<div class="row Signup">
				<input type="number" name="shopContact" value="<?php echo $row0['shopContact'] ?>" minlength="10" maxlength="10" title="O número de contato não está certo">
			</div>
	<br>
	
	<input type="submit" name="submit" value ="Feito" class="button"style=" padding: 6px; width: 47%;
  font-size: 125%;
  margin-bottom: 18px;">
  <input type="submit" name="editImg" value ="Editar imagem" class="button"style=" padding: 6px; width: 47%;
  font-size: 125%;
