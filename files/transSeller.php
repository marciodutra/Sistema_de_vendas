...
<html>
<head>
	<title>Histórico de transacoes</title>
...
<body>
		...
		<form action='sellerDashnavi.php' method='POST'
			...
			<p>
			<input type='submit' name='Psubmit' class="button" value='Voltar ao painel' style="width: 170px; height: 32px; padding: 0; text-align: center; margin:1px; font-size: 100%;" />
		</p>
	</form>
	<h1 style="margin-left: 3%;">
	Histórico de transacoes </h1>
